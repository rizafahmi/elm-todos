			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Todo$InputTodo),
							_1: {
								ctor: '::',
...
var _user$project$Todo$view = function (model) {
	return A2(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Todo$viewForm(model),
				_1: {
					ctor: '::',
					_0: _user$project$Todo$viewTodos(model),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Todo$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Todo$initialModel, view: _user$project$Todo$view, update: _user$project$Todo$update})();
